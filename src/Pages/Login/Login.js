      ...
      <Row className="py-4 justify-content-center align-items-center">
        ...
        <Col lg={4}>
          ...
          <Form onSubmit={handleSubmit}>
            ...
            <small className="text-center d-block my-2 d-flex justify-content-center">
              Don't have an account?
              <Nav.Link as={Link} to="/signup" className="mx-1 text-primary">
                Sign Up
              </Nav.Link>
            </small>
          ...
          <Button
            variant="dark"
            className="w-100 fw-bold d-block my-2"
